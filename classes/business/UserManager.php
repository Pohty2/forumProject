...
/**
 * The class usermanager calls on the functions in the usermanagerDB file.
 */
class UserManager
{
    ...
    public function getFirstNameById($id){
        return UserManagerDB::getFirstNameById($id);
    }
    public function searchUser($Fname,$Lname,$email,$number,$country,$city){
        return UserManagerDB::searchUser($Fname,$Lname,$email,$number,$country,$city);
    }
    ...
    /**
     * function randompassword generates a random password from numbers and both lower and upper case alphabets for the forget password website function.
     */
