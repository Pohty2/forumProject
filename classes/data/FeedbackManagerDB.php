...
/**
 * This is the feedbackmanagerDB class, containing functions to interact with the database.
 */
class FeedbackManagerDB
{
    /**
     * fillfeedback function fetches the data retrieved from the database and automatically returns them in an array..
     */
    ...
    /**
     * function to insert feedback with input given by user in the website form.
     */
